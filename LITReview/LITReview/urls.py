...
urlpatterns = [
    ...
    path('deleteticket/<int:id_ticket>', appweb.views.deleteticket, name='deleteticket'),
    path('deletereview/<int:id_review>', appweb.views.deletereview, name='deletereview'),
